...
def main():
    ...
    # Hoop zone setup button
    if not st.session_state.webcam_active:
        col1, col2 = st.columns([1, 1])
        with col1:
            if st.button("🎯 Setup Hoop Zone (Interactive)", use_container_width=True, type="primary"):
    ...
    if settings['webcam_active']:
        ...
        try:
            while st.session_state.webcam_active:
                ...
                scored = st.session_state.ball_tracker.update(ball_detections)
                if scored:
                    # Show scoring animation/sound could go here
                ...
                current_score = st.session_state.ball_tracker.score
                score_display.metric("🎯 SCORE", current_score, help="Total baskets made")
